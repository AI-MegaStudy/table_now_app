...
### 진행 중/예정 작업
- [ ] 서버 API 엔드포인트 구현 (`POST /api/customer/{customer_seq}/fcm-token`)
- [ ] 클라이언트 `sendTokenToServer` 메서드 구현
- [ ] DB 테이블 생성 (`device_token` 테이블)
- [ ] 로그인 시 자동 토큰 전송 구현
- [ ] 토큰 갱신 시 자동 전송 구현
...
- [ ] 4.1 서버 API 엔드포인트 구현
- [ ] 4.2 클라이언트 `sendTokenToServer` 메서드 구현
- [ ] 4.3 로그인 시 자동 전송 구현
- [ ] 4.4 토큰 갱신 시 자동 전송 구현
