...
-- weather 테이블 데이터
INSERT INTO `weather` (`weather_datetime`, `store_seq`, `weather_type`, `weather_low`, `weather_high`)
VALUES
  ('2026-01-15 00:00:00', 1, '맑음', 0.0, 0.0),
  ('2026-01-15 00:00:00', 2, '맑음', 0.0, 0.0),
  ('2026-01-18 00:00:00', 1, '눈', -0.13, 3.75),
  ('2026-01-18 00:00:00', 2, '눈', -0.13, 3.75),
  ('2026-01-18 00:00:00', 3, '눈', -0.13, 3.73),
  ('2026-01-19 00:00:00', 1, '눈', -7.97, 1.25),
  ('2026-01-19 00:00:00', 2, '눈', -8.33, 0.23)
ON DUPLICATE KEY UPDATE `weather_datetime` = VALUES(`weather_datetime`), `store_seq` = VALUES(`store_seq`), `weather_type` = VALUES(`weather_type`), `weather_low` = VALUES(`weather_low`), `weather_high` = VALUES(`weather_high`);
...
VALUES
  (1, 1, 1, '2026-01-15 00:00:00', '1,2', 2, '2026-01-23 12:00:00', '2026-01-15 12:20:00', 'paykey_demo_001', 'DONE'),
  (2, 2, 2, '2026-01-15 00:00:00', '6', 1, '2026-01-23 12:30:00', '2026-01-15 18:25:00', 'paykey_demo_002', 'DONE')
ON DUPLICATE KEY UPDATE `reserve_seq` = VALUES(`reserve_seq`), `store_seq` = VALUES(`store_seq`), `customer_seq` = VALUES(`customer_seq`), `weather_datetime` = VALUES(`weather_datetime`), `reserve_tables` = VALUES(`reserve_tables`), `reserve_capacity` = VALUES(`reserve_capacity`), `reserve_date` = VALUES(`reserve_date`), `created_at` = VALUES(`created_at`), `payment_key` = VALUES(`payment_key`), `payment_status` = VALUES(`payment_status`);
